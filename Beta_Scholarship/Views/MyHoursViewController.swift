...
class MyHoursViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, canEditRowAt indexPath: IndexPath) -> Bool {
        ...
        if !(tableView.cellForRow(at: indexPath)?.reuseIdentifier! == "Week Total") {
            return true
        }
        return false
    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        self.hoursTableView?.deselectRow(at: indexPath, animated: true)
    }
